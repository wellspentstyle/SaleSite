...
async function runDiagnostics() {
  ...
  console.log(`${colors.bright}${colors.cyan}║     Email Extraction System Diagnostics v1.0           ║${colors.reset}`);
  console.log(`${colors.bright}${colors.cyan}╚════════════════════════════════════════════════════════╝${colors.reset}\n`);
  ...
  console.log(`${colors.bright}🌐 Server Connectivity${colors.reset}`);
  console.log(`${colors.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}`);
  ...
  console.log(`${colors.bright}🤖 AI API Connectivity${colors.reset}`);
  console.log(`${colors.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}`);
  ...
  console.log(`${colors.bright}📊 Airtable Connectivity${colors.reset}`);
  console.log(`${colors.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}`);
  ...
  console.log(`${colors.bright}📬 Webhook Endpoint${colors.reset}`);
  console.log(`${colors.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}`);
  ...
  if (failed === 0 && warnings === 0) {
    ...
    console.log(`${colors.yellow}${colors.bright}⚠️  System mostly operational with warnings${colors.reset}`);
    console.log(`${colors.dim}Review warnings above and address if needed.${colors.reset}`);
  } else {
    console.log(`${colors.red}${colors.bright}❌ System not ready - fix failed checks${colors.reset}`);
  ...
  if (failed > 0) {
    ...
    console.log(`2. Run diagnostics again: node tools/diagnostics.js`);
  } else {
    console.log(`1. Run test suite: node tools/test-email-extraction.js`);
    console.log(`2. Start monitoring: node tools/email-monitor.js`);
    console.log(`3. Test real emails: node tools/analyze-rejection.js <email-file.txt>`);
  }
